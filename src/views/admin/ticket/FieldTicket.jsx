...
const FieldTicket = () => {
  return (
    ...
    <div className="ml-2 flex items-center flex-wrap space-x-5">
        ...
        <button className=" text-gray-900    dark:text-gray-300 flex  dark:text-gray-600"><IoMdEye className="h-6 w-6" />View</button>
        <button className=" text-gray-900    dark:text-gray-300 flex  dark:text-gray-600"><IoMdSettings className="h-6 w-6" />Edit</button>
